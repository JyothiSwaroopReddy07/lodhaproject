...
function FacilityManagement() {
    return (
        ...
        <div className="navBar" style={{backgroundColor:"rgb(36, 35, 35)"}}>
        
            <Nav variant="pills" defaultActiveKey="/home">
                <Nav.Item>
                    <Nav.Link className = "Link" href="/home">Survey</Nav.Link>
                </Nav.Item>
                
                <Nav.Item>
                    <Nav.Link className = "Link" eventKey="/Cultural">Meeting</Nav.Link>
                </Nav.Item>
                <Nav.Item>
                    <Nav.Link  className = "Link" eventKey="/Meetings">Cultural</Nav.Link>
                </Nav.Item>
            </Nav>
        </div>
